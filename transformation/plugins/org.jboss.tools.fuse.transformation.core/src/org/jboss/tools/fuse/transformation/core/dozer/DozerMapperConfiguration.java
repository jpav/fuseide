...
public class DozerMapperConfiguration implements MapperConfiguration {
    ...
    public static final String DOZER_6_XMLNS = "http://dozermapper.github.io/schema/bean-mapping"; //$NON-NLS-1$
    public static final String DOZER_6_SCHEMA_LOC = DOZER_6_XMLNS + " https://dozermapper.github.io/schema/bean-mapping.xsd"; //$NON-NLS-1$
    public static final String PRE_DOZER_6_XMLNS = "http://dozer.sourceforge.net"; //$NON-NLS-1$
    public static final String PRE_DOZER_6_SCHEMA_LOC = "http://dozer.sourceforge.net/schema/beanmapping.xsd"; //$NON-NLS-1$
    ...
    public void saveConfig(final OutputStream output) throws Exception {
        ...
        m.setProperty(Marshaller.JAXB_SCHEMA_LOCATION, DOZER_6_SCHEMA_LOC);
